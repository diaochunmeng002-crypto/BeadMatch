...
from games.beadsort.api import app
from games.beadsort.core import generator as g
from games.beadsort.core.free_solver import apply_move, is_finished, verify
...
class TestLibrary(unittest.TestCase):
    ...
    def test_home_page_serves_frontend(self):
        ...
        # 广场里页面在 `/games/beadsort/`，同一份代码两种跑法都对。
    ...
    def test_placeholder_when_no_frontend(self):
        ...
        from games.beadsort import api as app_module
