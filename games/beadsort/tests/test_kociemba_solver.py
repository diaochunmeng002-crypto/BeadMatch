...
# 2026-09-18：从 git 历史里捞回来的（当年叫 solver/kociemba_solver.py），
# 只把 import 改成包路径，别的没动 —— 它自带一份**独立写的暴力 BFS 对拍**。
from games.beadsort.core.kociemba_solver import (  # noqa: E402
    EMPTY,
    ColorSortSolver,
    make_vial,
    random_puzzle,
